...
public class Token implements Serializable{
	...
	public Token(Usuario usuario) {
		...
		this.token = generarToken(usuario.getNombre());
	 ...
	 * @param nombreUsuario nombre del usuario al que generar el token
	 ...
	 */
	private static String generarToken(String nombreUsuario) {
		try {
			return UUID.fromString(nombreUsuario).toString().toUpperCase();
